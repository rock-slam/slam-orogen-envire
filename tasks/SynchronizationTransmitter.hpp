...
#ifndef ENVIRE_SYNCHRONIZATIONTRANSMITTER_TASK_HPP
...
namespace envire {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','envire::SynchronizationTransmitter')
     end
     \endverbatim
    ...
    public:
         ...
         */
        SynchronizationTransmitter(std::string const& name = "envire::SynchronizationTransmitter", TaskCore::TaskState initial_state = Stopped);
         ...
         * \param initial_state The initial TaskState of the TaskContext. Default is Stopped state.
         */
        SynchronizationTransmitter(std::string const& name, RTT::ExecutionEngine* engine, TaskCore::TaskState initial_state = Stopped);

        /** Default deconstructor of SynchronizationTransmitter
         */
	~SynchronizationTransmitter();
